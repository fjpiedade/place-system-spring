...
<p align="center">
 <img src="https://img.shields.io/static/v1?label=Youtube&message=@raiztech&color=8257E5&labelColor=000000" alt="@raiztech" />
...
O Swagger poderá ser visualizado em [localhost:8080/swagger-ui.html](http://localhost:9009/swagger-ui.html)
...
```
docker run --name place-service -p 9009:9009  -d place-service
```
...
- POST /api/v1/places
```
http POST :9009/api/v1/places name="Place" state="State"
...
- GET /api/v1/places?name=?
```
http :9009/api/v1/places name==PLACE
HTTP/1.1 200 OK
Content-Type: application/json
...
```
http PATCH :9009/api/v1/places/1 name='New Name' state='New State'
HTTP/1.1 200 OK
Content-Length: 142
Content-Type: application/json
